...
const Links = () => (
  <div className="paper">
    ...
    <div className="row flex-center child-borders">
      <Link to="/blog" className="paper-btn paper-btn-3 font-btn margin">Blogs & Projects</Link>
      <a href={ RESUME_LINK } className="paper-btn paper-btn-1 font-btn margin">Résumé</a>
    </div>
  </div>
)
